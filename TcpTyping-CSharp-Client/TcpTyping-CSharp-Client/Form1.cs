...
namespace TcpTyping_CSharp_Client
{
    ...
    public partial class Form1 : Form
    {
        ...
        TcpClient client;
        Thread t1;
        string speed;       // server에서 넘어온 speed
        ...
        /* Server데이터 받아오며 threadedWorks로 쓰이는 함수. */
        private void recive()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    if (client != null)
                    {
                        ...
                        {
                            set_strList(ASCII.GetString(RecvBytes, 0, bytes));
                        }
                    }
                }
        ...
        private void set_speed(string speedbyte)
        {
            speed = speedbyte; 
        }
